...
#         self.tokenizer = GPT2Tokenizer.from_pretrained("Grossmend/rudialogpt3_medium_based_on_gpt2")
#         self.model = GPT2LMHeadModel.from_pretrained("Grossmend/rudialogpt3_medium_based_on_gpt2")
...
#         checkpoint = torch.load('drive/MyDrive/GPT2_checkpoint-more-data-2ep.pt', map_location='cpu')
